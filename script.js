...
elementWithId2.innerHTML="<br><h2>List all the food items with category fruit</h2><br>";
elementWithId2.innerHTML +=foodCategoryFruit(foodJson);

elementWithId3 = document.getElementById("3");
elementWithId3.innerHTML="<br><h2>List all the food items with category vegetables</h2><br>";
elementWithId3.innerHTML += foodCategoryVegetable(foodJson);

elementWithId4 = document.getElementById("4");
elementWithId4.innerHTML="<br><h2>List all the food items with category grains</h2><br>";
elementWithId4.innerHTML +=foodCategoryGrains(foodJson);
...
elementWithId6.innerHTML="<br><h2>List all the food items with category protien</h2><br>";
elementWithId6.innerHTML +=foodCategoryProtien(foodJson);
